...
3. **[USER_PERSONAS.md](USER_PERSONAS.md)** *(20-25 min read)*
...
7. **[SCOPE.md](SCOPE.md)** *(15-20 min read)*
...
5. USER_FLOWS.md (understand workflows)
...
**Deliverables format:**
- Low-fidelity wireframes: Figma frames
- High-fidelity mockups: Figma frames (production-ready)
...
## Designer Qualifications We're Looking For
...
├── USER_FLOWS.md                  ← 16 user journeys
...
**Job Posting → Hire → Project Completion:**
...
**Looking forward to seeing your portfolio and working together!** 🚀
